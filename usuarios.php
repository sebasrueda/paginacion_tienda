<?php
    ...
    $conteo_resultados = mysqli_query($conexion, "SELECT COUNT(*) as total_registros FROM taller1.usuarios") or die(mysqli_error($conexion));
    ...
    // String de consulta
    $sql = "SELECT * FROM taller1.usuarios LIMIT $desplazamiento, $filas_por_pagina";
